...
public class CampfireTransformEffect extends AbstractGameEffect {
    ...
    public void update() {
        ...
        if (this.duration < 1.0F && !this.openedScreen) {
            ...
            AbstractDungeon.gridSelectScreen.open(CardGroup.getGroupWithoutBottledCards(AbstractDungeon.player.masterDeck.getPurgeableCards()), 1, TEXT[2], false, true, true, false);
        }
